(function () {
    ...
    function setup() {
      ...
      words = commonWords;
        ...
        man.innerHTML = 'You have ' + rounds + ' rounds remaining';
        output.innerHTML = '';
    ...
    document.getElementById('hangman').onsubmit = function (e) {
        ...
        if (guess) {
            ...
            if (availableLetters.indexOf(guess) > -1) {
                ...
                /* guess doesn't exist in current word and hasn't been guessed before, add to lettersGuessed, reduce rounds & update user */
                else {
                    lettersGuessed += guess;
                    rounds--;
                    man.innerHTML = 'You have ' + rounds + ' rounds remaining';
                    if (rounds === 0) gameOver();
                }
            }
